...
public class Home extends javax.swing.JFrame {
    ...
    public void addJournal(JournalModel data) {
        ...
        journal.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent me) {
                if (SwingUtilities.isLeftMouseButton(me)) {
                    event.journalClick(journal, data);
                }
            }
        });
        panel.add(journal);
    ...
    public void setSelected(Component journal) {
        for (Component com : panel.getComponents()) {
            Journal i = (Journal) com;
            if (i.isSelected()) {
                i.setSelected(false);
            }
        }
        ((Journal) journal).setSelected(true);
    }
//
//    public void showJournal(JournalModel data) {
...
//    }
    ...
    private void initComponents() {
        ...
        sidepaneLayout.setHorizontalGroup(
            ...
            .addComponent(jPanel3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 209, Short.MAX_VALUE)
